...
def encoder_weighted_test(random_seed,num_client,sum_weight = 1):
    ...
    for client in client_list:
        ...
        #     print(f"Client {client.client_id} has this type")
        # else:
        #     print(f"Client {client.client_id} does NOT have this type!!!!")
    ...
    if sum_weight == 1:
        ...
        evalute_accuracy(result, true, label, random_seed, "encoder weighted")
    else:
